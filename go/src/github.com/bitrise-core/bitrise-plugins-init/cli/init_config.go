...
const bitriseSecretsTemplateStr = `envs:
- MY_HOME: $HOME
...
const bitriseConfigTemplateStr = `format_version: {{.FormatVersion}}
...
func generateBitriseYMLContent(config ConfigModel) (string, error) {
	...
	bitriseConfigTemplate, err := bitriseConfigTemplate.Parse(bitriseSecretsTemplateStr)
	if err != nil {
...
func initConfig(c *cli.Context) {
	...
	bitriseSecretsContent := bitriseSecretsTemplateStr
